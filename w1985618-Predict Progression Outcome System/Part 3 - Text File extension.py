...
print("Staff version and histogram with file handling\n")
while Continue == "y":
    while True:
...
# open created file to read the progression data
with open("p_outcome.txt", "r") as pro_file:
